...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamEvents = channel.stream_stream(
                ...
                request_serializer=streaming__pb2.ControlRequest.SerializeToString,
                response_deserializer=streaming__pb2.Event.FromString,
...
def add_EventServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamEvents': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=streaming__pb2.ControlRequest.FromString,
                    response_serializer=streaming__pb2.Event.SerializeToString,
            ),
    }
...
class EventService(object):
    ...
    def StreamEvents(request_iterator,
        ...
        return grpc.experimental.stream_stream(
            ...
            target,
            '/events.EventService/StreamEvents',
            streaming__pb2.ControlRequest.SerializeToString,
            streaming__pb2.Event.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
